...
# Define dataset path
dataset_path = "/content/drive/MyDrive/Dataset/Rice_Pest/Pest_V2"  # Change to your dataset location
...
# Define dataset path
dataset_path = "/content/drive/MyDrive/Dataset/Rice_Pest/Pest_V2"  # Change to your dataset path
