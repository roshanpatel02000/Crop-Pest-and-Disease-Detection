...
# Define dataset path
dataset_path = "/content/drive/MyDrive/Dataset/Wheat"  # Change to your dataset location
...
# Define dataset path
dataset_path = "/content/drive/MyDrive/Dataset/Wheat"  # Change to your dataset path
