...
# Define dataset path
dataset_path = "/content/drive/MyDrive/Dataset/Rice_Diseases"  # Change to your dataset location
...
# Define dataset path
dataset_path = "/content/drive/MyDrive/Dataset/Rice_Diseases"  # Change to your dataset path
